...
protected:
	...
	UPROPERTY(EditAnywhere, Category="Ammo", Replicated, meta = (ClampMin = 0, ClampMax = 100))
	int32 MagazineSize = 10;

	/** Number of bullets in the current magazine */
	UPROPERTY(ReplicatedUsing = OnRep_CurrentBullets, VisibleAnywhere, BlueprintReadOnly, Category="Ammo")
	...
	/** Flag tracking if we've subscribed to owner's destroyed event */
	bool bSubscribedToOwnerDestroyed = false;
...
public:
	...
	/** Replication notify for CurrentBullets */
	UFUNCTION()
	void OnRep_CurrentBullets(int32 OldValue);
...
public:
	...
	/** Configure replication for this weapon */
