...
protected:
	...
	/** Time to wait after death before respawning (0 = destroy instead) */
	UPROPERTY(EditAnywhere, Category="Damage")
	...
	/** Initial spawn location for respawning */
	FVector InitialSpawnLocation;

	/** Initial spawn rotation for respawning */
...
protected:
	...
	UFUNCTION()
	void OnRep_CurrentHP(float OldValue);

	/** Configure replication for this actor */
...
protected:
	...
	/** Called after death timer to respawn the NPC */
	void Respawn();
